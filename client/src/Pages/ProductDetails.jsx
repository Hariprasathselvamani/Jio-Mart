...
const ProductDetails = () => {
  ...
  const placeholderImage =
    "https://res.cloudinary.com/ddqexm4wz/image/upload/v1756909811/ula2pt2ylx7oyntv1hzs.png";
  ...
  useEffect(() => {
    if (product?.images?.length > 0) {
      ...
      setThumbnail(placeholderImage); // ✅ fallback to placeholder
    }
  }, [product]);
  ...
  return (
    <div className="mt-12">
      ...
      <div className="flex flex-col items-center mt-20">
        ...
        <button
          className="mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary-dull hover:bg-primary/10 transition"
          onClick={() => {
            navigate("/products");
            scrollTo(0, 0);
          }}
